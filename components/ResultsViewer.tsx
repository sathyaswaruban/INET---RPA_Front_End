...
export const ResultsViewer = memo(({ responseData }: ResultsViewerProps) => {
    ...
    const dataSections = [
        ...
        { key: "VEND_IHUB_SUC-NIL", label: "Vend_IHub_Succ - Not_In_Ledger" },
        { key: "VEND_FAIL_IHUB_SUC-NIL", label: "Vend_IHub_Fail - Not_In_Ledger" },
        { key: "VEND_SUC_IHUB_FAIL-NIL", label: "Vend_Suc - IHub_Fail - Not_In_Ledger" },
        { key: "IHUB_INT_VEND_SUC-NIL", label: "Vend_Suc - Ihub_Ini - Not_In_Ledger" },
        { key: "VEND_FAIL_IHUB_INT-NIL", label: "Vend_Fail - Ihub_Ini - Not_In_Ledger" },
